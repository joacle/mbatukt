...
const contactInfos: ContactInfo[] = [
  ...
  },
  {
    icon: <Mail size={24} />,
    title: "Email",
    content: "info@batucadavibrante.com",
    link: "mailto:info@batucadavibrante.com"
  },
  {
    icon: <MapPin size={24} />,
    title: "Dirección",
    content: "Calle Ritmo 42, 28001 Madrid"
  }
];
            ...
            <div className="glass-card h-full scroll-watch">
              ...
              <div className="space-y-6">
                {contactInfos.map((info, index) => (
                  <div key={index} className="flex items-start">
                    <div className="text-batucada-orange mr-4">
                      {info.icon}
                    </div>
                    <div>
                      ...
                      {info.link ? (
                        <a 
                          href={info.link} 
                          className="text-gray-600 hover:text-batucada-orange transition-colors"
                        >
                          {info.content}
                        </a>
                      ) : (
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="#" 
                    className="w-10 h-10 rounded-full bg-batucada-dark text-white flex items-center justify-center hover:bg-batucada-orange transition-colors"
                    aria-label="Facebook"
                  >
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-batucada-orange transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-batucada-orange transition-all resize-none"
